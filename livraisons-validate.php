                                ...
                                <form method="post" action="controller/LivraisonsNonPayeesValidateController.php" class="horizontal-form">
                                    <div class="row-fluid">
                                        ...
                                        ?>
                                                ...
                                                Date : <?= date('d/m/Y', strtotime($livraison->dateLivraison())) ?>
                                                | Libelle : <?= $livraison->libelle() ?>
                                                | Nombre Articles : <?= $livraisonDetailManager->getNombreArticleLivraisonByIdLivraison($livraison->id()) ?>
                                                | Total : <?= number_format($livraisonDetailManager->getTotalLivraisonByIdLivraison($livraison->id()), 2, ',', ' ') ?>
