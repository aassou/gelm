                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <div class="tiles">
                            ...
                            <a href="projet-biens.php?idProjet=<?= $idProjet ?>&type=maisons&idSociete=<?= $idSociete ?>" class="btn btn-box green">
                                Maisons
                            </a>
                            <a href="projet-biens.php?idProjet=<?= $idProjet ?>&type=locaux&idSociete=<?= $idSociete ?>" class="btn btn-box blue">
                                Locaux Commerciaux
                            </a>
                            <a href="projet-biens.php?idProjet=<?= $idProjet ?>&type=terrains&idSociete=<?= $idSociete ?>" class="btn btn-box yellow">
                                Terrains
                            </a>
                        </div>
                    </div>
