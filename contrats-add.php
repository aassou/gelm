                              ...
                              <div class="portlet-body form">
                                 ...
                                 <form action="controller/ContratAddController.php" method="POST" class="horizontal-form">
                                    ...
                                    <div class="form-actions">
                                    	...
                                    	<a href="contrats-list.php?idProjet=<?= $idProjet ?>" class="btn black"><i class="icon-remove m-icon-white"></i> Annuler</a>
                                    	<a href="clients-add.php?idProjet=<?= $idProjet ?>" class="btn red"><i class="m-icon-swapleft m-icon-white"></i> Retour vers Client</a>
