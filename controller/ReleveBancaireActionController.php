<?php
            ...
            if ( $invalid != 1 ) {
                ...
                if ( $response ) {
                    ...
                    $history = new History(array(
                        'action' => "Ajout",
                        'target' => "Table des relevés bancaires",
                        'description' => "Ajout d'un nouveau relevé bancaire",
                        'created' => $created,
                        'createdBy' => $createdBy
                    ));
                    //add it to db
    ...
    //Action Update Processing Begin
        ...
        if(!empty($_POST['dateOpe'])){
            ...
            $history = new History(array(
                'action' => "Modification",
                'target' => "Table des relevés bancaires",
                'description' => "Modification de l'opération ID : ".$idReleveBancaire,
                'created' => $created,
                'createdBy' => $createdBy
            ));
            //add it to db
    ...
    //Action Delete Processing Begin
        ...
        $history = new History(array(
            'action' => "Suppression",
            'target' => "Table des relevés bancaires",
            'description' => "Suppression de l'opération ID : ".$idReleveBancaire,
            'created' => $created,
            'createdBy' => $createdBy
        ));
        //add it to db
