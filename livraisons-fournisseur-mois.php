                        ...
                        <div class="portlet livraisons">
                            <div class="portlet-body">
                                ...
                                <table class="table table-striped table-bordered table-advance table-hover">
                                    <thead>
                                        <tr>
                                            <th style="width: 50%">Mois / Année</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="livraisons">
                                            ...
                                            <!--td>
                                                <?php //number_format($sommeReglements, 2, ',', ' '); ?>
                                            </td>
                                            <td>
                                                <?php //number_format( $totalDetailsLivraisons - $sommeReglements, 2, ',', ' '); ?>
                                            </td-->
                                        </tr>
                                        <?php
                                        }//end of loop
                                    ...
                                    <tr>
                                        ...
                                        <!--th><strong><a><?php //number_format($grandTotalReglements, 2, ',', ' ') ?>&nbsp;DH</a></strong></th>
                                        <th><strong><a><?php //number_format($totalLivraison - $grandTotalReglements, 2, ',', ' ') ?>&nbsp;DH</a></strong></th-->
                                    </tr>
                                </table>
