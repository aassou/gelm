            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <h3 class="page-title">
                            Archive des livraisons - Fournisseur : <strong><?= $fournisseur->nom() ?></strong> 
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <div class="portlet">
                                ...
                                <div class="row-fluid">
                                    <div class="span3">
                                      <div class="control-group">
                                         <div class="controls">
                                           <a class="btn" href="<?php //$updateLink ?>" data-toggle="modal" style="width: 200px">
                            ...
                            <!--a target="_blank" href="controller/LivraisonDetailPrintController.php?idLivraison=<?php //$livraison->id() ?>&societe=1" class="get-down btn blue pull-right">
                            ...
                            <tr>
                                ...
                                <!--td class="hidden-phone">
                                    <a class="btn mini green" href="#updateLivraisonDetail<?php //$detail->id();?>" data-toggle="modal" data-id="<?php //$detail->id(); ?>">
                                        <i class="icon-refresh "></i>
                                    </a>
                                    <a class="btn mini red" href="#deleteLivraisonDetail<?php //$detail->id();?>" data-toggle="modal" data-id="<?php //$detail->id(); ?>">
                            ...
                            <table class="table table-striped table-bordered table-advance table-hover">
                                <tbody>
                                    <tr>
                                        <th style="width: 75%"><strong>Grand Total</strong></th>
                                        <th style="width: 25%"><strong><a><?= number_format($totalLivraisonDetail, 2, ',', ' ') ?>&nbsp;DH</a></strong></th>
                                    </tr>
                                </tbody>
                            </table>
                            <!--table class="table table-striped table-bordered table-advance table-hover">
