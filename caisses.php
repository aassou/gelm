    ...
    <div class="page-container row-fluid sidebar-closed">
        ...
        <div class="page-content">
            ...
            <div class="container-fluid">
                ...
                <!-- BEGIN PAGE CONTENT-->
                <div class="row-fluid">
                    <a class="btn green pull-right" href="#addCaisse" data-toggle="modal">
                ...
                <div id="addCaisse" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" action="controller/CaisseActionController.php" method="post">
                            <div class="control-group">
                                <label class="control-label">Nom de la caisse</label>
                                <div class="controls">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="tab-pane active" id="tab_1">
                            <?php if(isset($_SESSION['caisse-action-message'])){ 
                                    $typeMessage = $_SESSION['caisse-type-message'];    
                            ?>
                            <div class="alert alert-<?= $typeMessage ?>">
                                <button class="close" data-dismiss="alert"></button>
                                <?= $_SESSION['caisse-action-message'] ?>     
                            </div>
                             <?php } 
                           ...
                           <div class="portlet box">
                              <div class="portlet-body">
                                    ...
                                    ?>
                                    <div class="btn-group">
                                        <a class="btn blue big dropdown-toggle fixed-size" href="#" data-toggle="dropdown">
                                            Caisse <strong><?= ucfirst($caisse->nom()) ?></strong> 
                                    ...
                                    <div id="updateCaisse<?= $caisse->id() ?>" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                            <h3>Modifier les informations de la caisse </h3>
                                        </div>
                                        <div class="modal-body">
                                            <form class="form-horizontal" action="controller/CaisseActionController.php" method="post">
                                                <p>Êtes-vous sûr de vouloir modifier les informations de caisse <strong>N°<?= $caisse->id() ?></strong>  ?</p>
                                                <div class="control-group">
                                                    <label class="control-label">Nom de la caisse</label>
                                                    <div class="controls">
                                                        <input type="text" name="nom" value="<?= $caisse->nom() ?>" />
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    <label class="control-label">Date Création</label>
                                                    <div class="controls date date-picker" data-date="" data-date-format="yyyy-mm-dd">
                                                        <input name="dateCreation" id="dateCreation" class="m-wrap m-ctrl-small date-picker" type="text" value="<?= $caisse->dateCreation() ?>" />
                                                        <span class="add-on"><i class="icon-calendar"></i></span>
                                                     </div>
                                                </div>
                                                <div class="control-group">
                                    ...
                                    <div id="deleteCaisse<?= $caisse->id() ?>" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                            <h3>Supprimer la caisse </h3>
                                        </div>
                                        <div class="modal-body">
                                            <form class="form-horizontal loginFrm" action="controller/CaisseActionController.php" method="post">
                                                <p>Êtes-vous sûr de vouloir supprimer la caisse <strong><?= $caisse->nom() ?></strong> ?</p>
                                                <div class="control-group">
