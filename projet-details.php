							...
							<div class="span12">
								<div class="portlet">
									...
									<div id="addProjetDocs<?= $projet->id() ?>" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
										...
										<form class="form-horizontal" action="controller/ProjetPiecesAddController.php?source=2" method="post" enctype="multipart/form-data">
									...
									<div class="portlet-body">
										<?php
										foreach($piecesProjet as $pieces){
										?>
										<div class="span3">
											<div class="item">
										...
										<div id="deletePiece<?= $pieces->id();?>" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
											...
											<div class="modal-body">
												<form class="form-horizontal loginFrm" action="controller/ProjetPiecesDeleteController.php" method="post">
