                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <!--div class="span12"-->
                            ...
                            ?>
                            <!--div style="background-color: #f7f7f7" class="row-fluid" id="<?php //$societe->id() ?>"-->
                                <div class="get-down stay-away-right">
                                    <a style="width:250px;" href="company.php?idSociete=<?= $societe->id() ?>" class="btn green big dropdown-toggle fixed-size" href="#" data-toggle="dropdown">
