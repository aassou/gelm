                    ...
                    <div class="span12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li>
                                ...
                                <a>Liste des tâches de société</a>
                            </li>
                        </ul>
                    ...
                    <div class="span12">
                        <div class="portlet">
                            <div class="portlet-title line">
                                <h4><i class="icon-check"></i>Ajouter une tâche de société</h4>
                                <!--div class="tools">
                            ...
                            <div class="portlet-body" id="chats">
                                <div class="chat-form">
                                    <form action="controller/TodoSocieteActionController.php" method="POST">
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <?php if ( $todo->priority() == "Todo" ) { ?>
                                            <a href="include/delete-task-societe.php?idTask=<?= $todo->id() ?>&idSociete=<?= $societe->id() ?>"><i class="icon-remove"></i></a>
                                    ...
                                    <div id="updateTodo<?= $todo->id() ?>" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" action="controller/TodoSocieteActionController.php" method="post">
