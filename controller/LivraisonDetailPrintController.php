...
<page backtop="15mm" backbottom="20mm" backleft="10mm" backright="10mm">
	...
	<table class="detailLivraison">
		<tr>
			...
			<td style="width: 30%"><?= $projet->nom() ?></td>
			<th style="width: 20%">Fournisseur</th>
			<td style="width: 30%"><?= $fournisseur->nom() ?></td>
		</tr>
		<tr>
			<th style="width: 20%">Libelle</th>
			<td style="width: 30%"><?= $livraison->libelle() ?></td>
			<th style="width: 20%">Date</th> 
			<td style="width: 30%"><?= date('d/m/Y', strtotime($livraison->dateLivraison())) ?></td>
		</tr>
	</table>
	<br>
